function [plots_disp_f,rois_f,pixtounits,units,cutoff_corrcoef,lenscoef,outstate] = ncorr_abr_gui_formatdisp(reference,current,roi,plots_u_ref,plots_v_ref,plots_corrcoef_ref,spacing,pos_parent,params_init)
