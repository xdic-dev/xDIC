...
%         D1=minDist(V1(indBoundary1,:),evenlySampleCurve(V2(edgeListToCurve(Eb2_crop),:),4*size(Eb2_crop,1)));
...
%         D2=minDist(V2(indBoundary2,:),evenlySampleCurve(V1(edgeListToCurve(Eb1_crop),:),4*size(Eb1_crop,1)));
