function [seedinfo,outstate] = ncorr_abr_gui_seedpreview(reference,current,roi,num_region,pos_seed,radius,cutoff_diffnorm,cutoff_iteration,enabled_stepanalysis,subsettrunc,num_img,total_imgs,pos_parent)
...
% if all images are seeded correctly, or else it will return failed.
    ...
    function constructor()        
        ...
        [seedinfo_prelim,convergence_prelim,outstate_seeds] = ncorr_abr_alg_seedanalysis(reference, ...
                                                                                     current, ...
                                                                                     roi, ...
                                                                                     num_region, ...
                                                                                     pos_seed, ...
        ...
        if (outstate_seeds == out.success)
            ...
            if (any(paramvectorcollection(:,9) > 0.4))
                ...
                disp('!! WARNING !!');
                disp('High correlation coefficient detected. One of the seed points is possibly incorrect. Proceed with caution.')
            end
        ...
        % ABR - AUTO TRIGGER CLICK BUTTON FINISH
